...
HOST = '192.168.0.110'  # Use the IP address of your server machine within the LAN
PORT = 9999
...
def add_message(message):
    timestamp = datetime.datetime.now().strftime('%H:%M:%S')  # Get current timestamp
    message_with_timestamp = f"[{timestamp}] {message}"  # Append timestamp to message
